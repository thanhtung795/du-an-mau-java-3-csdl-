CREATE DATABASE EduSys_PS27852
GO
...
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'ThanhTung', N'songlong', N'Võ Thanh Tùng','tungvtps27852@fpt.edu.vn', 1)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'LongNDH', N'songlong', N'Nguyễn Đình Hoàng Long','longndhps12345@fpt.edu.vn', 0)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'LongNDT', N'songlong', N'Nguyễn Đình Thiên Long','longndtps12345@fpt.edu.vn', 0)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'NghiemN', N'songlong', N'Nguyễn Nghiệm','nghiemNps12345@fpt.edu.vn', 1)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'NoPT', N'123456', N'Phạm Thị Nở','noptps12345@fpt.edu.vn', 0)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'PheoNC', N'123456', N'Nguyễn Chí Phèo','pheocnps21324@fpt.edu.vn', 0)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'TeoNV', N'songlong', N'Nguyễn Văn Tèo','teonvps32142@fpt.edu.vn', 1)
INSERT [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen],[Email], [VaiTro]) VALUES (N'ThaoLTH', N'songlong',N'Lê Thị Hương Thảo','thaolthps23142@fpt.edu.vn', 0)
...
UPDATE [dbo].[NhanVien]
SET TinhTrangHonNhan = N'Có gia đình'
WHERE MaNV = N'ThanhTung';

UPDATE [dbo].[NhanVien]
SET TinhTrangHonNhan = N'Chưa có gia đình'
WHERE MaNV = N'LongNDH';

UPDATE [dbo].[NhanVien]
SET TinhTrangHonNhan = N'Đã ly hôn'
WHERE MaNV = N'LongNDT';

-- Tiếp tục cho các hàng còn lại...
