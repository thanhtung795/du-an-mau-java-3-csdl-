...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlStatusBar1 = new javax.swing.JPanel();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/Edu.png"))); // NOI18N
        ...
        pnlStatusBar1.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));

        lblClock1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lblClock1.setForeground(new java.awt.Color(255, 51, 51));
        lblClock1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/icons8_alarm_clock_25px.png"))); // NOI18N

        lblUserInfo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/icons8_username_25px.png"))); // NOI18N

        javax.swing.GroupLayout pnlStatusBar1Layout = new javax.swing.GroupLayout(pnlStatusBar1);
        pnlStatusBar1.setLayout(pnlStatusBar1Layout);
        pnlStatusBar1Layout.setHorizontalGroup(
            pnlStatusBar1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStatusBar1Layout.createSequentialGroup()
                .addComponent(lblUserInfo1, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 419, Short.MAX_VALUE)
                .addComponent(lblClock1, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        pnlStatusBar1Layout.setVerticalGroup(
            pnlStatusBar1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblClock1, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
            .addComponent(lblUserInfo1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(pnlStatusBar1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(10, 10, 10))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(4, 4, 4)
                .addComponent(pnlStatusBar1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void StartClook() {
        class TimeClook extends Thread {

            @Override
            public void run() {
                while (true) {                    
                    String Time = FormatTime();
                lblClock1.setText(Time);
                }
            }
        }
        TimeClook TCL = new TimeClook();
        TCL.start();
    }
    ...
    public void DisplayUser(){
        ...
        String role = Auth.user.isVaiTro()?"Manager":"Employees";
        lblUserInfo1.setText("UserID: " + User + " / Role: " + role);
    }
    public void Exit() {
        if (MsgBox.confirm(this, "Do you want exit?")) {
            System.exit(0);
        }
    }
    ...
    public void OpenLearners() {
        new LearnersDialog(this, true).setVisible(true);
    }

    public void OpenCourses() {
        new CourseDialog(this, true).setVisible(true);
    }
    ...
    public void OpenEmployees() {
        new EmployeesDialog(this, true).setVisible(true);
    }
    ...
    public void OpenStatistic(int i) {
        try {
            StatisticDialog stdl = new StatisticDialog(this, true);
            stdl.selectTab(i);
    ...
    private javax.swing.JPanel pnlStatusBar1;
