...
public class CourseDialog extends javax.swing.JDialog {
    ...
    public CourseDialog(java.awt.Frame parent, boolean modal) {
        ...
        txtCreator.setText(Auth.user.getMaNV());
    }
    ...
    private void initComponents() {
        ...
        btnDel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/icons8_delete_20px.png"))); // NOI18N
        ...
        lblSubjectTitle.setText("Subject");
        ...
        lblFDOS.setText("First day of school");

        txtDayCreated.setEditable(false);

        jLabel7.setText("Day of creation");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SUBJECTS", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.PREFERRED_SIZE, 413, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CourseDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CourseDialog dialog = new CourseDialog(new javax.swing.JFrame(), true);
    ...
    private com.toedter.calendar.JDateChooser txtFDOS;
   ...
   void fillComboBoxChuyenDe() {
    ...
    KhoaHoc getForm(int i) {
        int row = (int) tblCourse.getValueAt(i, 0);
        KhoaHoc kh = new KhoaHoc();
        ChuyenDe cd = (ChuyenDe) cboSubjects.getSelectedItem();
